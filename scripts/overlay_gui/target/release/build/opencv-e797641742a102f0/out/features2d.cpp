...
cv::BRISK* cv_BRISK_defaultNew_const() {
		cv::BRISK* ret = new cv::BRISK();
		return ret;
}
...
void cv_DescriptorMatcher_write_const_const_PtrLFileStorageGR(const cv::DescriptorMatcher* instance, const cv::Ptr<cv::FileStorage>* fs, ResultVoid* ocvrs_return) {
	try {
		instance->write(*fs);
		Ok(ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
...
void cv_Feature2D_write_const_const_PtrLFileStorageGR(const cv::Feature2D* instance, const cv::Ptr<cv::FileStorage>* fs, ResultVoid* ocvrs_return) {
	try {
		instance->write(*fs);
		Ok(ocvrs_return);
	} OCVRS_CATCH(ocvrs_return);
...
cv::SIFT* cv_SIFT_defaultNew_const() {
		cv::SIFT* ret = new cv::SIFT();
		return ret;
}
...
cv::SimpleBlobDetector* cv_SimpleBlobDetector_defaultNew_const() {
		cv::SimpleBlobDetector* ret = new cv::SimpleBlobDetector();
		return ret;
}
