...
extern "C" {
	const cv::dnn::ReduceLayerInt8* cv_PtrLcv_dnn_ReduceLayerInt8G_getInnerPtr_const(const cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			return instance->get();
	}

	cv::dnn::ReduceLayerInt8* cv_PtrLcv_dnn_ReduceLayerInt8G_getInnerPtrMut(cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			return instance->get();
	}

	cv::Ptr<cv::dnn::ReduceLayerInt8>* cv_PtrLcv_dnn_ReduceLayerInt8G_new_null_const() {
			return new cv::Ptr<cv::dnn::ReduceLayerInt8>();
	}

	void cv_PtrLcv_dnn_ReduceLayerInt8G_delete(cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			delete instance;
	}

	cv::Ptr<cv::Algorithm>* cv_PtrLcv_dnn_ReduceLayerInt8G_to_PtrOfAlgorithm(cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			return new cv::Ptr<cv::Algorithm>(instance->dynamicCast<cv::Algorithm>());
	}

	cv::Ptr<cv::dnn::Layer>* cv_PtrLcv_dnn_ReduceLayerInt8G_to_PtrOfLayer(cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			return new cv::Ptr<cv::dnn::Layer>(instance->dynamicCast<cv::dnn::Layer>());
	}

	cv::Ptr<cv::dnn::ReduceLayer>* cv_PtrLcv_dnn_ReduceLayerInt8G_to_PtrOfReduceLayer(cv::Ptr<cv::dnn::ReduceLayerInt8>* instance) {
			return new cv::Ptr<cv::dnn::ReduceLayer>(instance->dynamicCast<cv::dnn::ReduceLayer>());
	}

	cv::Ptr<cv::dnn::ReduceLayerInt8>* cv_PtrLcv_dnn_ReduceLayerInt8G_new_const_ReduceLayerInt8(cv::dnn::ReduceLayerInt8* val) {
