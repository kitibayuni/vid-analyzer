...
cv::dnn::ReduceLayerInt8* cv_dnn_Layer_to_ReduceLayerInt8(cv::dnn::Layer* instance) {
		return dynamic_cast<cv::dnn::ReduceLayerInt8*>(instance);
}
...
int cv_dnn_ReduceLayer_propReduceType_const(const cv::dnn::ReduceLayer* instance) {
		int ret = instance->reduceType;
		return ret;
}

void cv_dnn_ReduceLayer_propReduceType_const_int(cv::dnn::ReduceLayer* instance, const int val) {
		instance->reduceType = val;
}

std::vector<size_t>* cv_dnn_ReduceLayer_propReduceDims_const(const cv::dnn::ReduceLayer* instance) {
		std::vector<size_t> ret = instance->reduceDims;
		return new std::vector<size_t>(ret);
}

void cv_dnn_ReduceLayer_propReduceDims_const_vectorLsize_tG(cv::dnn::ReduceLayer* instance, const std::vector<size_t>* val) {
...
cv::dnn::ReduceLayerInt8* cv_dnn_ReduceLayerInt8_defaultNew_const() {
		cv::dnn::ReduceLayerInt8* ret = new cv::dnn::ReduceLayerInt8();
		return ret;
}

cv::Algorithm* cv_dnn_ReduceLayerInt8_to_Algorithm(cv::dnn::ReduceLayerInt8* instance) {
		return dynamic_cast<cv::Algorithm*>(instance);
}

cv::dnn::Layer* cv_dnn_ReduceLayerInt8_to_Layer(cv::dnn::ReduceLayerInt8* instance) {
		return dynamic_cast<cv::dnn::Layer*>(instance);
}

cv::dnn::ReduceLayer* cv_dnn_ReduceLayerInt8_to_ReduceLayer(cv::dnn::ReduceLayerInt8* instance) {
		return dynamic_cast<cv::dnn::ReduceLayer*>(instance);
}

void cv_dnn_ReduceLayerInt8_delete(cv::dnn::ReduceLayerInt8* instance) {
		delete instance;
}
