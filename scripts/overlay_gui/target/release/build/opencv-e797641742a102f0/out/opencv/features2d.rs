pub mod features2d {
	...
	impl BRISK {
		...
		#[inline]
		pub fn default() -> crate::features2d::BRISK {
			let ret = unsafe { sys::cv_BRISK_defaultNew_const() };
			let ret = unsafe { crate::features2d::BRISK::opencv_from_extern(ret) };
			ret
		}
	...
	pub trait DescriptorMatcherTraitConst: core::AlgorithmTraitConst {
		...
		/// ## Note
		/// This alternative version of [DescriptorMatcherTraitConst::write_to_storage_ptr_with_name] function uses the following default values for its arguments:
		/// * name: String()
		#[inline]
		fn write_to_storage_ptr_with_name_def(&self, fs: &core::Ptr<core::FileStorage>) -> Result<()> {
			return_send!(via ocvrs_return);
			unsafe { sys::cv_DescriptorMatcher_write_const_const_PtrLFileStorageGR(self.as_raw_DescriptorMatcher(), fs.as_raw_PtrOfFileStorage(), ocvrs_return.as_mut_ptr()) };
			return_receive!(ocvrs_return => ret);
			let ret = ret.into_result()?;
			Ok(ret)
		}
	...
	pub trait Feature2DTraitConst: core::AlgorithmTraitConst {
		...
		/// ## Note
		/// This alternative version of [Feature2DTraitConst::write_to_storage_ptr_with_name] function uses the following default values for its arguments:
		/// * name: String()
		#[inline]
		fn write_to_storage_ptr_with_name_def(&self, fs: &core::Ptr<core::FileStorage>) -> Result<()> {
			return_send!(via ocvrs_return);
			unsafe { sys::cv_Feature2D_write_const_const_PtrLFileStorageGR(self.as_raw_Feature2D(), fs.as_raw_PtrOfFileStorage(), ocvrs_return.as_mut_ptr()) };
			return_receive!(ocvrs_return => ret);
			let ret = ret.into_result()?;
			Ok(ret)
		}
	...
	impl SIFT {
		/// Creates a default instance of the class by calling the default constructor
		#[inline]
		pub fn default() -> crate::features2d::SIFT {
			let ret = unsafe { sys::cv_SIFT_defaultNew_const() };
			let ret = unsafe { crate::features2d::SIFT::opencv_from_extern(ret) };
			ret
		}
		...
		#[inline]
		pub fn create_with_descriptor_type(nfeatures: i32, n_octave_layers: i32, contrast_threshold: f64, edge_threshold: f64, sigma: f64, descriptor_type: i32) -> Result<core::Ptr<crate::features2d::SIFT>> {
			return_send!(via ocvrs_return);
	...
	impl SimpleBlobDetector {
		/// Creates a default instance of the class by calling the default constructor
		#[inline]
		pub fn default() -> crate::features2d::SimpleBlobDetector {
			let ret = unsafe { sys::cv_SimpleBlobDetector_defaultNew_const() };
			let ret = unsafe { crate::features2d::SimpleBlobDetector::opencv_from_extern(ret) };
			ret
		}
