pub mod aruco {
	...
	#[inline]
	pub fn estimate_pose_board_def(corners: &impl ToInputArray, ids: &impl ToInputArray, board: &core::Ptr<crate::aruco::Board>, camera_matrix: &impl ToInputArray, dist_coeffs: &impl ToInputArray, rvec: &mut impl ToInputOutputArray, tvec: &mut impl ToInputOutputArray) -> Result<i32> {
		input_array_arg!(corners);
		input_array_arg!(ids);
		input_array_arg!(camera_matrix);
		input_array_arg!(dist_coeffs);
	...
	/// * use_extrinsic_guess: false
	#[inline]
	pub fn estimate_pose_board(corners: &impl ToInputArray, ids: &impl ToInputArray, board: &core::Ptr<crate::aruco::Board>, camera_matrix: &impl ToInputArray, dist_coeffs: &impl ToInputArray, rvec: &mut impl ToInputOutputArray, tvec: &mut impl ToInputOutputArray, use_extrinsic_guess: bool) -> Result<i32> {
		input_array_arg!(corners);
		input_array_arg!(ids);
		input_array_arg!(camera_matrix);
		input_array_arg!(dist_coeffs);
	...
	/// * use_extrinsic_guess: false
	#[inline]
	pub fn estimate_pose_charuco_board_def(charuco_corners: &impl ToInputArray, charuco_ids: &impl ToInputArray, board: &core::Ptr<crate::aruco::CharucoBoard>, camera_matrix: &impl ToInputArray, dist_coeffs: &impl ToInputArray, rvec: &mut impl ToInputOutputArray, tvec: &mut impl ToInputOutputArray) -> Result<bool> {
		input_array_arg!(charuco_corners);
		input_array_arg!(charuco_ids);
		input_array_arg!(camera_matrix);
		input_array_arg!(dist_coeffs);
	...
	/// * use_extrinsic_guess: false
	#[inline]
	pub fn estimate_pose_charuco_board(charuco_corners: &impl ToInputArray, charuco_ids: &impl ToInputArray, board: &core::Ptr<crate::aruco::CharucoBoard>, camera_matrix: &impl ToInputArray, dist_coeffs: &impl ToInputArray, rvec: &mut impl ToInputOutputArray, tvec: &mut impl ToInputOutputArray, use_extrinsic_guess: bool) -> Result<bool> {
		input_array_arg!(charuco_corners);
		input_array_arg!(charuco_ids);
		input_array_arg!(camera_matrix);
		input_array_arg!(dist_coeffs);
	...
	impl Board {
		...
		#[inline]
		pub fn default() -> crate::aruco::Board {
			let ret = unsafe { sys::cv_aruco_Board_defaultNew_const() };
	...
	impl CharucoBoard {
		/// Creates a default instance of the class by calling the default constructor
		#[inline]
		pub fn default() -> crate::aruco::CharucoBoard {
			let ret = unsafe { sys::cv_aruco_CharucoBoard_defaultNew_const() };
	...
	impl std::fmt::Debug for DetectorParameters {
		...
		fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
			f.debug_struct("DetectorParameters")
				...
				.field("use_aruco3_detection", &crate::aruco::DetectorParametersTraitConst::use_aruco3_detection(self))
				.field("min_side_length_canonical_img", &crate::aruco::DetectorParametersTraitConst::min_side_length_canonical_img(self))
				.field("min_marker_length_ratio_original_img", &crate::aruco::DetectorParametersTraitConst::min_marker_length_ratio_original_img(self))
				.finish()
		}
	}
	...
	impl GridBoard {
		/// Creates a default instance of the class by calling the default constructor
		#[inline]
		pub fn default() -> crate::aruco::GridBoard {
			let ret = unsafe { sys::cv_aruco_GridBoard_defaultNew_const() };
