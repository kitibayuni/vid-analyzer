pub mod calib3d {
	...
	/// vectors (see matMulDeriv ). The functions are used inside [stereo_calibrate] but can also be used in
	...
	/// information as described in [Malis](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Malis) . The summary of the method: the [decompose_homography_mat] function
	...
	/// The fundamental matrix may be calculated using the [find_fundamental_mat] function. See [HartleyZ00](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_HartleyZ00) 11.4.3 for details.
	/// ## Parameters
