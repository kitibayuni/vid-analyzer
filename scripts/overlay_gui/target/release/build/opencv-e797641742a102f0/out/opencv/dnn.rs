pub mod dnn {
	...
	boxed_cast_descendant! { Layer, crate::dnn::ReduceLayerInt8, cv_dnn_Layer_to_ReduceLayerInt8 }
	...
	pub trait ReduceLayerTraitConst: crate::dnn::LayerTraitConst {
		...
		fn reduce_type(&self) -> i32 {
			let ret = unsafe { sys::cv_dnn_ReduceLayer_propReduceType_const(self.as_raw_ReduceLayer()) };
			ret
		}

		#[inline]
		fn reduce_dims(&self) -> core::Vector<size_t> {
			let ret = unsafe { sys::cv_dnn_ReduceLayer_propReduceDims_const(self.as_raw_ReduceLayer()) };
			let ret = unsafe { core::Vector::<size_t>::opencv_from_extern(ret) };
			ret
		}
	...
	pub trait ReduceLayerTrait: crate::dnn::LayerTrait + crate::dnn::ReduceLayerTraitConst {
		...
		fn set_reduce_type(&mut self, val: i32) {
			let ret = unsafe { sys::cv_dnn_ReduceLayer_propReduceType_const_int(self.as_raw_mut_ReduceLayer(), val) };
			ret
		}

		#[inline]
		fn set_reduce_dims(&mut self, val: core::Vector<size_t>) {
			let ret = unsafe { sys::cv_dnn_ReduceLayer_propReduceDims_const_vectorLsize_tG(self.as_raw_mut_ReduceLayer(), val.as_raw_VectorOfsize_t()) };
			ret
		}
	...
	impl std::fmt::Debug for ReduceLayer {
		...
		fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
			f.debug_struct("ReduceLayer")
				.field("reduce_type", &crate::dnn::ReduceLayerTraitConst::reduce_type(self))
				.field("reduce_dims", &crate::dnn::ReduceLayerTraitConst::reduce_dims(self))
				.field("blobs", &crate::dnn::LayerTraitConst::blobs(self))
				.field("name", &crate::dnn::LayerTraitConst::name(self))
				.field("typ", &crate::dnn::LayerTraitConst::typ(self))
				.field("preferable_target", &crate::dnn::LayerTraitConst::preferable_target(self))
	...
	impl Drop for ReduceLayerInt8 {
		#[inline]
		fn drop(&mut self) {
			unsafe { sys::cv_dnn_ReduceLayerInt8_delete(self.as_raw_mut_ReduceLayerInt8()) };
		}
	}
	...
	impl ReduceLayerInt8 {
		/// Creates a default instance of the class by calling the default constructor
		#[inline]
		pub fn default() -> crate::dnn::ReduceLayerInt8 {
			let ret = unsafe { sys::cv_dnn_ReduceLayerInt8_defaultNew_const() };
			let ret = unsafe { crate::dnn::ReduceLayerInt8::opencv_from_extern(ret) };
			ret
		}

		#[inline]
		pub fn create(params: &impl crate::dnn::LayerParamsTraitConst) -> Result<core::Ptr<crate::dnn::ReduceLayerInt8>> {
			return_send!(via ocvrs_return);
	...
	impl Default for ReduceLayerInt8 {
		#[inline]
		/// Forwards to infallible Self::default()
		fn default() -> Self {
			Self::default()
	...
	impl std::fmt::Debug for ReduceLayerInt8 {
		#[inline]
		fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
			f.debug_struct("ReduceLayerInt8")
				.field("blobs", &crate::dnn::LayerTraitConst::blobs(self))
				.field("name", &crate::dnn::LayerTraitConst::name(self))
				.field("typ", &crate::dnn::LayerTraitConst::typ(self))
				.field("preferable_target", &crate::dnn::LayerTraitConst::preferable_target(self))
	...
	boxed_cast_base! { ReduceLayerInt8, core::Algorithm, cv_dnn_ReduceLayerInt8_to_Algorithm }

	boxed_cast_base! { ReduceLayerInt8, crate::dnn::Layer, cv_dnn_ReduceLayerInt8_to_Layer }

	boxed_cast_base! { ReduceLayerInt8, crate::dnn::ReduceLayer, cv_dnn_ReduceLayerInt8_to_ReduceLayer }
	...
	boxed_ref! { ReduceLayerInt8, core::AlgorithmTraitConst, as_raw_Algorithm, core::AlgorithmTrait, as_raw_mut_Algorithm }
	...
	boxed_ref! { ReduceLayerInt8, crate::dnn::LayerTraitConst, as_raw_Layer, crate::dnn::LayerTrait, as_raw_mut_Layer }
	...
	boxed_ref! { ReduceLayerInt8, crate::dnn::ReduceLayerTraitConst, as_raw_ReduceLayer, crate::dnn::ReduceLayerTrait, as_raw_mut_ReduceLayer }
	...
	boxed_ref! { ReduceLayerInt8, crate::dnn::ReduceLayerInt8TraitConst, as_raw_ReduceLayerInt8, crate::dnn::ReduceLayerInt8Trait, as_raw_mut_ReduceLayerInt8 }
